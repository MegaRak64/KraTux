...
void HvH::RenderTab()
{
	const char* yTypes[] = {
			...
			"LISP", "LISP SIDE", "LISP JITTER", "ANGEL BACKWARDS", "ANGEL INVERSE", "ANGEL SPIN", "LOWERBODY", "LBYONGROUND", "LUA UNCLAMPED", "LUA UNCLAMPED2", "AUTISM", "ZEUSJITTER", "TANK", "FAKEHEAD", "CUSTOM1", "CUSTOM2" // untrusted
	};

	const char* xTypes[] = {
			"UP", "DOWN", "DANCE", "FRONT", "LUA", "CUSTOM", // safe
			"FAKE UP", "FAKE DOWN", "LISP DOWN", "ANGEL DOWN", "ANGEL UP", "FAKEPITCH", "DOWNZERO", "UPZERO", "FAKEZERO", "EMOTION", "LUA UNCLAMPED" // untrusted
	};
