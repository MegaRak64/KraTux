...
"LISP", "LISP SIDE", "LISP JITTER", "ANGEL BACKWARDS", "ANGEL INVERSE", "ANGEL SPIN", "LOWERBODY", "LBYONGROUND", "LUA UNCLAMPED", "LUA UNCLAMPED2", "AUTISM", "ZEUSJITTER", "JITTER 180", "TANK", "FAKEHEAD", "CUSTOM1", "CUSTOM2" // untrusted
	};
